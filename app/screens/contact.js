    ...
    return (
        ...
        >
            <View style={styles.card_template}>
                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.card_titleLOGO}>Explain why someone should contact them, and describe how they can help solve their visitors' problems. Include an email and phone number so visitors can quickly find the right information. Include a short form using fields that'll help the business understand who's contacting them.</Text>
            ...
            <View style={styles.card_template}>
                <TouchableOpacity
                    style={styles.button}
                    // onPress={() => navigation.navigate('GovtNavi')}
                >

                    <View style={styles.card_body}>
                      
                        <Text style={styles.contactHeading}><Entypo name="phone" size={24} color="black" /> 0302-8798679 </Text>
                        <Text style={styles.contactHeading}><MaterialIcons name="email" size={24} color="black" /> Admin@repoerter.com</Text>
                        <Text style={styles.contactHeading}><Foundation name="web" size={24} color="black" /> www.repoerter.com</Text>
