...
export default function ProfileScreen({ navigation }) {
    ...
    const { user, setUser, setChange, change } = useContext(AuthContext);
    ...
    return (
        ...
        <View style={styles.container} >
            ...
            <ListItem
                title="My Complains"
                IconComponent={<Icon name="alert-circle-outline" backgroundColor="red" />}
                ...
                <Screen style={styles.modal}>
                    ...
                    >
                        ...
                        <View style={authStyle.registerBtn}>
                            ...
                            {!loading ? <SubmitButton title='Change Password' /> : <ActivityIndicator color={Colors.black} visible={loading} />}
                        </View>
                    </Form>
